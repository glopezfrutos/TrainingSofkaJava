...
public class Game {
    ...
    private static void declareQuestion() {
        ...
        nivel1[1] = new Question("¿Cuál es el océano más grande del mundo?", "Océano Antártico", "Océano Atlántico", "Océano Indico", "Océano Pacífico", 4);
        ...
        nivel5[1] = new Question("¿En qué país de Africa el español es la lengua oficial?", "Cabo Verde", "Sierra Leona", "Guinea ecuatorial", "Liberia", 3);
    ...
    public void Jugar() {
        ...
        Question auxQuestion[] = new Question[5];

        //elegir el nivel del juego
        for (int i = 0; i < auxQuestion.length; i++) {
            auxQuestion[i] = nivel1[i];
        }
        ...
        do {
            int i = 0;
            //mostrar Pregunta
            System.out.println("\n Pregunta:" + auxQuestion[i].getEnunciado() +
                    "\n OpcionA:" + auxQuestion[i].getOpcion1() +
                    "\n Opcion B:" + auxQuestion[i].getOpcion2() +
                    "\n Opcion C:" + auxQuestion[i].getOpcion3() +
                    "\n Opcion D:" + auxQuestion[i].getOpcion4());
            //Pedir Respuesta
            int opc = scanner.nextInt();

            //Validamos
            if (opc == auxQuestion[i].getRespuesta()) {
                validacio = true;
                score++;
            } else {
                validacio = false;
